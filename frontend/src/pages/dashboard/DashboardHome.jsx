...
const DashboardHome = () => {
  const { user } = useAuth();
  const { overview, getOverview, isLoading } = useDashboard();
        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Here's what's happening with your solar energy platform today.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="p-4 sm:p-5">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-8 sm:h-8 bg-primary-500 rounded-full flex items-center justify-center">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-8 sm:h-8 bg-green-500 rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 9.343l1.172-1.171a4 4 0 115.656 0L21 8.343V6a2 2 0 00-2-2H5a2 2 0 00-2 2v2.343zM12 10.657l-5.172 5.172a4 4 0 01-5.656 0L1 16.657V18a2 2 0 002 2h14a2 2 0 002-2v-1.343l-5.172-5.172z" clipRule="evenodd" />
                    </svg>
                  </div>
                </div>
                <div className="ml-4 sm:ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-xs sm:text-sm font-medium text-gray-500 truncate">Active Investors</dt>
                    <dd className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-900">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-8 sm:h-8 bg-red-500 rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v2a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                  </div>
                </div>
                <div className="ml-4 sm:ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-xs sm:text-sm font-medium text-gray-500 truncate">Pending Applications</dt>
                    <dd className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-900">
