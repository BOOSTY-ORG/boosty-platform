...
import performanceDashboardRoutes from './metrics/performance-dashboard.routes.js';
import performanceRealtimeRoutes from './metrics/performance-realtime.routes.js';
import performanceAnalyticsRoutes from './metrics/performance-analytics.routes.js';
import performanceConfigurationRoutes from './metrics/performance-configuration.routes.js';
